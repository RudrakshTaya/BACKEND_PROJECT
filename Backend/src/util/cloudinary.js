...
cloudinary.config({
    cloud_name: process.env.CLOUDINARY_CLOUD_NAME || 'dmv2g9b6g',
    api_key: process.env.CLOUDINARY_API_KEY || '382997848933675',
    api_secret: process.env.CLOUDINARY_API_SECRET || 'JD_AYPQm-IRNXMgMb2_ZxIr3798',
});
